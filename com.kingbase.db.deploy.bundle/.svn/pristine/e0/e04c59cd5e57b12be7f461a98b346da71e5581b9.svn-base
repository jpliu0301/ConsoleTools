...
public class MasterFirstPage {
	...
	public Composite getCom(Composite composite1, String[] nodeName,
		...
		String[] string = new String[] { "库", "物理机器", "节点类型", "监听地址" };
		...
		if (oldReadEntity != null) {
			...
			if (oldReadEntity.getPosEntity().getIsDbBase()) {
				...
				txt8.setText(oldReadEntity.getPosEntity().getListenerPort());
	...
	public PosEntity getEntity() {
		...
		entity.setListenerPort(txt8.getText());
