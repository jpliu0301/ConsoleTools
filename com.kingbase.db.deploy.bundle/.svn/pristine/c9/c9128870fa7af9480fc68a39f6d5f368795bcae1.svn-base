...
public class MasterMenuProvider extends ContextMenuProvider {
	...
	public void buildContextMenu(IMenuManager menu) {
		...
		if (obj instanceof DeployContetntsPart) {
			...
			CommonMasterAction actionStart = new CommonMasterAction(editor.getEditDomain().getEditorPart(), entity, "start",
					editor);
			actionRegistry.registerAction(actionStart);

			CommonMasterAction actionDisable = new CommonMasterAction(editor.getEditDomain().getEditorPart(), entity, "disable",
					editor);
			actionRegistry.registerAction(actionDisable);

			CommonMasterAction actionRestart = new CommonMasterAction(editor.getEditDomain().getEditorPart(), entity, "restart",
					editor);
			...
			if(!mainNodeDB.getType().equals("up")){
